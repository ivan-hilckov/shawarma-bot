...
### 🤖 Telegram Bot (обновленный UX v2.6)

- 🎯 **Упрощенное меню** - 5 кнопок вместо 8, снижение сложности на 37.5%
- 🛒 **Умная корзина** - динамический счетчик товаров, адаптивные кнопки
- 👤 **Централизованный профиль** - заказы, избранное, рекомендации в одном месте
- 📦 **Улучшенные карточки товаров** - фото, подробные описания, умное поведение кнопок
- ⭐ **Система избранного** - сохранение любимых товаров для быстрого заказа
- 🎯 **Персональные рекомендации** - на основе истории заказов и времени суток
...
### v2.7 - Analytics API (планируется)
