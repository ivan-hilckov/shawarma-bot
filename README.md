...
- 📱 **Telegram Mini App** - веб-приложение внутри Telegram ✨ НОВОЕ
...
- 🏪 **botgarden.store** - основной магазин с API интеграцией
- 🛒 **botgarden.shop** - торговая площадка (в разработке)
- 🔧 **botgarden.tech** - техническая документация
- 🌐 **botcraft.tech** - сервис крафт-ботов (концепт)
- 🎮 **botgrover.fun** - игровые боты с мини-игрой
...
2. **Нажмите "🌯 Открыть Шаурма App"** - Mini App откроется в Telegram
3. **Используйте навигацию** - переключайтесь между страницами
4. **Проверьте данные** - кнопка покажет информацию о вашем профиле
